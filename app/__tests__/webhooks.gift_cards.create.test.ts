...
const sendWhatsAppMock = sendGiftCardWhatsApp as unknown as Mock;
...
function runAction(payload: Record<string, any>, shop = "test.myshopify.com") {
  ...
  return action({
    request: new Request("http://localhost/webhooks/gift_cards/create", {
      method: "POST",
    }),
  } as any);
}
        ...
        data: {
          giftCard: {
            ...
            lineItem: {
              ...
              customAttributes: [{ key: "Recipient name", value: "Sara" }],
              order: {
