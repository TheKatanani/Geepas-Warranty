...
async function main() {
  ...
  console.log("Testing variant inventoryQuantities in productSet mutation...");
  ...
  // Update variant SKU GWD17021 with quantity 15
  const input = {
  ...
  try {
    ...
    console.log("productSet Quantity Response:\n", JSON.stringify(json, null, 2));
  } catch (e: any) {
